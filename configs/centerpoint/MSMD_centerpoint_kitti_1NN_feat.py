...
# original Kitti image resolution is (375, 1242)
img_scale = (640, 192)
...
model = dict(
    ...
    multimodal_middle_encoder=dict(
        ...
        # in_channels_2D = (6, 6, 6, 6),
        in_channels_2D = (262, 262, 262, 262),
        out_channels=(32, 64, 128, 128),
        padding=(1, 1, [0, 1, 1], 0),
        # in_channels_3D=(32, 64, 128),
        # in_channels_2D=(259, 259, 259),
...
optimizer = dict(type='AdamW', lr=lr, betas=(0.95, 0.99), weight_decay=0.01,
                paramwise_cfg=dict(custom_keys={'img_backbone': dict(lr_mult=0.1, decay_mult=0.),
                                                'img_neck': dict(lr_mult=0.1, decay_mult=0.)}))
...
log_level = 'INFO'
work_dir = None
load_from = './checkpoints/img_backbone_R50.pth'
# load_from = None
# resume_from = './work_dirs/MSMD_centerpoint_kitti_1NN/epoch_3.pth'
resume_from = None
workflow = [('train', 1)]
