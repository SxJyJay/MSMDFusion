...
optimizer = dict(type='AdamW', lr=0.0002, weight_decay=0.01)  # for 8gpu * 2sample_per_gpu
...
work_dir = None
load_from = None
# resume_from = "/share/home/jiaoyang/code/TransFusion/work_dirs/transfusion_nusc_voxel_L/epoch_15.pth"
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
